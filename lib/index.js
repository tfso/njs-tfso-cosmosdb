...
class DocumentDBClient {
    ...
    get client() {
        if (this._client == null) {
            this._client = new cosmos_1.CosmosClient({ endpoint: this.host, key: this.key, connectionPolicy: this._policy }); // new CosmosClient(`AccountEndpoint=${this.host};AccountKey=${this.key};`,)
        }
        return this._client;
    }
    makeEntity(doc) {
